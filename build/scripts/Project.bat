...
set CLASSPATH=%APP_HOME%\lib\Project-1.0.0.jar;%APP_HOME%\lib\opencsv-4.3.2.jar;%APP_HOME%\lib\commons-text-1.3.jar;%APP_HOME%\lib\commons-lang3-3.8.1.jar;%APP_HOME%\lib\commons-beanutils-1.9.3.jar;%APP_HOME%\lib\commons-collections4-4.2.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-collections-3.2.2.jar

@rem Execute Project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" oops.project.Main %CMD_LINE_ARGS%
